...
const AlogInputComponent = (props:any) => {
    ...
    return(
        <div className=" max-w-[500px] bg-white p-8 rounded-lg shadow-lg text-gray-800 text-sm font-light text-transparent bg-clip-text bg-gradient-to-r to-black from-blue-500">
